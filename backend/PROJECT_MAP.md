...
- Fait et testé (35 tests) : `/health`, module identité (UC-01 + auth JWT), module établissements/classes, module inscriptions (UC-02/UC-03).
- En cours : recrutement/contrats (UC-04 à UC-05b), pédagogie/évaluations (UC-06 à UC-09), actes académiques (UC-10 — modèle révisé le 2026-09-24 vers un catalogue d'actes configurable par établissement, cf. `docs/cas-utilisation-phase-1.md`).
...
- **Limitation assumée** : `POST /inscriptions` n'accepte que les tuteurs — l'auto-inscription directe par un élève ≥16 ans sans tuteur (prévue par UC-02) n'est pas implémentée.
...
2026-09-24 — après le module inscriptions (UC-02/UC-03).
