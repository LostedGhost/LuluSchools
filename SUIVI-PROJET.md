...
- [ ] **4. Backend** — tous les endpoints développés, testés et documentés, un par un (en cours : `GET /health`, `POST /auth/tuteurs`, `POST /auth/tuteurs/verify-otp` faits — voir `docs/contrat-api-phase1.md`)
